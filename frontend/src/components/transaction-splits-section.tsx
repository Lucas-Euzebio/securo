...
export function TransactionSplitsSection({
  ...
  // this and "split into parts" (mutually exclusive — a transaction
  // can't be both a shared group expense and divided into standalone
  // parts) and renders both toggles itself.
  enabled: boolean
}) {
