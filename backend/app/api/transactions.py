...
async def list_transactions(
    ...
    transfer_only: bool = Query(False, description="Show only transactions linked as a transfer pair"),
    ...
    transactions, total, summary = await transaction_service.get_transactions(
        ...
        txn_type=type, exclude_transfers=exclude_transfers, transfer_only=transfer_only,
